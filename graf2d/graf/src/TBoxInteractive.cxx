...
void TBoxInteractive::CalcPixelCoord(TVirtualPad &parent, Double_t x1, Double_t y1, Double_t x2, Double_t y2)
{
...
{
    return mode != pNone && mode != pINSIDE;
}

///////////////////////////////////////////////////////////////////////////////
/// Return selected opaque mode

Bool_t TBoxInteractive::IsOpaque(TVirtualPad &parent) const
{
...
Bool_t TBoxInteractive::ProcessMouseMove(TVirtualPad &parent, Int_t px, Int_t py, Bool_t canX, Bool_t canY, Double_t aspectRatio)
{
...
void TBoxInteractive::SetCursor(TVirtualPad &parent, Bool_t is_down)
{
   switch (mode) {
